		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comtrsmartcontrol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtrsmartcontrol-display": {
								"semanticObject": "comtrsmartcontrol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tr.smartcontrol",
									"url": sap.ui.require.toUrl("com/tr/smartcontrol")
								}
							}
						}
					}
